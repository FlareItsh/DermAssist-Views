...
<template>
  <Teleport to="body">
    <Transition name="modal">
      ...
      >
        <div
          class="bg-card border-border flex max-h-[90vh] flex-col overflow-y-auto rounded-3xl border shadow-2xl lg:flex-row"
        >
          <!-- Left side: Calendar -->
          <div class="p-6">
          ...
          <div
            class="bg-foreground/5 flex w-[95vw] max-w-2xl flex-col justify-center p-8 lg:w-[34rem]"
          >
            ...
            <div class="mb-4">
              ...
              <div
                class="rounded-xl border border-gray-200 bg-white p-3 font-semibold text-indigo-600"
              >
            ...
            <div class="mb-4">
              ...
              <div
                ...
                class="mt-2 rounded-xl border border-red-200 bg-red-50 p-2.5 text-xs font-bold text-red-600"
              >
              ...
              <div
                v-if="errorMessage"
                class="mt-2 flex items-start gap-1.5 rounded-xl border border-red-200 bg-red-50 p-2.5 text-xs font-bold text-red-600"
              >
                <Icon
                  name="material-symbols:warning-rounded"
                  class="mt-0.5 shrink-0 text-base text-red-500"
                />
              ...
              <Transition name="fade-scale">
                ...
                >
                  ...
                  <div>
                    ...
                    <p class="mt-0.5 text-red-500">
                      The doctor has no scheduled duty hours on this date. Please select an
                      available date from the calendar.
                    </p>
                  </div>
                </div>
              </Transition>
            ...
            <div class="mb-8">
              ...
              <div class="space-y-2">
                <select
                  ...
                  class="text-foreground w-full cursor-pointer rounded-xl border border-gray-200 bg-white p-3 text-sm font-medium outline-none focus:border-indigo-500"
                >
                  <option
                    value=""
                    disabled
                ...
                <input
                  ...
                  class="w-full rounded-xl border border-gray-200 bg-white p-3 text-sm outline-none focus:border-indigo-500"
                />
              </div>
            </div>
