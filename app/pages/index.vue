<template>
  <div class="mb-12 flex flex-col justify-center gap-20 px-12">
    <div>
      ...
      <NuxtImg src="/images/lp-img.png" class="mx-auto mb-2 h-screen w-auto" alt="CTA" />
      <NuxtLink to="/admin/dashboard" class="absolute z-10 cursor-pointer rounded-full"
    ...
    <div>
      ...
      <div class="flex flex-wrap justify-center gap-10">
        <div v-for="feature in features" :key="feature.title"
          ...
          <div class="bg-secondary text-card flex h-35 w-35 w-fit items-center justify-center rounded-full p-7">
            <div v-if="feature.icon.startsWith('<svg')" v-html="feature.icon"
              class="flex h-20 w-20 items-center justify-center [&>svg]:h-full [&>svg]:w-full"></div>
            <Icon v-else :name="feature.icon" class="text-7xl" />
          </div>
    ...
    <div>
      ...
      <div class="flex gap-10">
        <NuxtImg src="/images/contact-us-img.png" class="h-auto w-1/2 rounded-[25px] object-cover" alt="contact" />
        ...
        <div class="bg-card flex w-1/2 flex-col rounded-[25px] p-15 px-25">
          ...
          <textarea
            class="bg-primary-light ring-secondary h-32 resize-none rounded-xl px-4 py-2 outline-none focus:ring-1"></textarea>

          <div class="mt-4 flex items-center justify-start gap-2">
            <input type="checkbox" class="accent-secondary h-4 w-4 cursor-pointer" />
...
const features = [
  {
    ...
    description:
      'Take a photo of your skin concern using your device. Our AI analyzes it instantly to detect potential conditions. Quick, simple, and safe.',
  ...
  },
  {
    ...
    description:
      'Receive a detailed report highlighting possible skin conditions, severity, and recommendations.',
  ...
  },
  {
    ...
    description:
      'Chat with licensed dermatologists to confirm results and get personalized treatment advice. ',
