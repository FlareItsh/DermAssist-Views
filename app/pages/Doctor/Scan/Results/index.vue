...
const { currentDiagnosis, isScanned, isHealthyState, isInconclusiveState, isOutOfScopeState, isNoneState, chartData, patientUuid, isProceededToResults, saveActiveDiagnosisState, clearDiagnosis, resetScanner } = useDiagnosis()
