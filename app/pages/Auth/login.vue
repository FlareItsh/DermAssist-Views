  ...
  <div class="flex h-full flex-col items-center justify-center px-12 py-8">
    ...
    >
      ...
      <button
        type="submit"
        :disabled="isLoading"
        class="bg-primary text-primary-foreground shadow-primary/20 mt-4 flex w-full items-center justify-center gap-2 rounded-2xl py-4 font-bold shadow-lg transition-all hover:opacity-90 active:scale-95 disabled:cursor-not-allowed disabled:opacity-70"
      >
        <Icon
          v-if="isLoading"
